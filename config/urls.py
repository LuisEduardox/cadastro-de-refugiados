...
from refugees.views import RefugeesListView, RefugeesUpdateView, RefugeesDeleteView, DashboardTemplateView, HomeTemplateView, create_refugee_register
...
urlpatterns = [
    ...
    path('registrar/', create_refugee_register, name="create_refugee"),
